...
export const findUserById = (uid) => usersModel.findById(uid, {password: false})
export const findUserByUsername = (username) => usersModel.findOne({userName: username})
export const findUserByCredentials = async (username, password) => await usersModel.findOne({userName: username, password: password})
